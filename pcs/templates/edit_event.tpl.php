...
<?php
if (isset($_SESSION['edit_event_form'])) {
  $defaults = new DefaultFormValues($_SESSION['edit_event_form']);
}
else {
...
<div class="pcs">
  ...
  <div>
    ...
    <form action="index.php?a=edit_event_submit" method="post">

      <input type="hidden" name="event_id" value="<?php print $this->event->getEventId(); ?>" />

      <div class="item">
        Please remember that you are editing existing event. Its id is: <?php print $this->event->getEventId(); ?><br />
        The autogenerated forum topic <a href="http://forums.dust-gents.com/viewtopic.php?f=16&t=<?php print $this->event->getForumThread(); ?>">should be edited manually here</a>.
      </div>

      <div class="item">
        <label class="description" for="event_type">Event Type</label>
        <?php $selected_event_type = $defaults->getProp('event_type', $this->event->getType()); ?>
        <div>
      ...
      <div class="item">
        ...
        <div>
          <input class="district_location" name="district_location" type="text" maxlength="200" length="200" value="<?php print $defaults->getProp('district_location', $this->event->getDistrictLocation()); ?>">
        </div>
      </div>
      <script>
        jQuery(function() {
      ...
      <div class="item">
        ...
        <div>
          <input class="platoon_leader" name="platoon_leader" type="text" maxlength="200" length="200" value="<?php print $defaults->getProp('platoon_leader', $this->event->getPlatoonLeader()); ?>">
        </div>
      </div>
      ...
      <div class="item">
        ...
        <div>
          <input class="backup_platoon_leaders" name="backup_platoon_leaders" type="text" maxlength="200" length="200" value="<?php print $defaults->getProp('backup_platoon_leaders', $this->event->getBackupPlatoonLeaders()); ?>">
        </div>
      </div>
      ...
      <div class="item">
        ...
        <div>
          <input class="enemy_corp" name="enemy_corp" type="text" maxlength="200" length="200" value="<?php print $defaults->getProp('enemy_corp', $this->event->getEnemyCorp()); ?>">
        </div>
      </div>
      ...
      <div class="item">
        ...
        <div>
          <input class="friendly_corp" name="friendly_corp" type="text" maxlength="200" length="200" value="<?php print $defaults->getProp('friendly_corp', $this->event->getFriendlyCorp()); ?>">
        </div>
      </div>

      <?php $dateWidget = new DateWidget(); print $dateWidget->render($defaults, $this->event->getEveDate()); ?>

      <div class="item">
        <?php $selected_duration = $defaults->getProp('duration', $this->event->getDuration()); ?>
      ...
      <input class="submit" type="submit" name="submit" value="Edit Event">
    </form>
  </div>
</div>